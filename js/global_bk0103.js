...
function initOurTeam(viewMode)
{
	...
	function initOverlay()
	{
		...
		function setContent(num)
		{
			...
			emailDiv.innerHTML = findID(num)[0].email;
...
function genTopNav(){
	...
	str +='<li><a class="page-class-41" href="' + homeHref + 'where-we-play/america-footprint-city-guide/washington-dc.html">Washington</a></li>';
	str +='</ul>';
	str +='</div>';
	str +='<div class="subSectionItem lastItem">';
	...
	str +='<li><a class="page-class-113" href="' + homeHref + 'our-research/city-briefings/americas/washington-dc-briefing.html">Washington</a></li>';
	str +='</ul>';
	str +='</div>';
	str +='<div class="subSectionItem lastItem">';
	...
	str +='<div class="subNavItemWrapper">';
	str +='<a href="#" class="printThisPage">Print this page</a>';
